### Benchmark commands
```
./redis/src/redis-benchmark -p 3000 -t set -n 5000 -r 10000

./redis/src/redis-benchmark -n 5000 -t get -c 100 -h localhost -p 3000 -r 100000 --threads 3
```
...
```
Summary:
  throughput summary: 16181.23 requests per second
  latency summary (msec):
          avg       min       p50       p95       p99       max
        3.079     0.128     0.935     8.191    21.023    73.791
```
